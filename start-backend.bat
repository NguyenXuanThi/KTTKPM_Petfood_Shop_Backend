...
start "API Gateway :3000" cmd /k "cd /d %~dp0petfood_be\api-gateway && npm run dev"
timeout /t 2 /nobreak >nul

echo [2/16] Starting Auth Service (port 3001)...
start "Auth Service :3001" cmd /k "cd /d %~dp0petfood_be\auth-service && npm run dev"
timeout /t 2 /nobreak >nul

echo [3/16] Starting User Service (port 3002)...
start "User Service :3002" cmd /k "cd /d %~dp0petfood_be\user-service && npm run dev"
timeout /t 2 /nobreak >nul

echo [4/16] Starting Product Service (port 3003)...
start "Product Service :3003" cmd /k "cd /d %~dp0petfood_be\product-service && npm run dev"
timeout /t 2 /nobreak >nul

echo [5/16] Starting Order Service (port 3004)...
start "Order Service :3004" cmd /k "cd /d %~dp0petfood_be\order-service && npm run dev"
timeout /t 2 /nobreak >nul

echo [6/16] Starting Category Service (port 3005)...
start "Category Service :3005" cmd /k "cd /d %~dp0petfood_be\category-service && npm run dev"
timeout /t 2 /nobreak >nul

echo [7/16] Starting Upload Service (port 3006)...
start "Upload Service :3006" cmd /k "cd /d %~dp0petfood_be\upload-service && npm run dev"
timeout /t 2 /nobreak >nul

echo [8/16] Starting Cart Service (port 3007)...
start "Cart Service :3007" cmd /k "cd /d %~dp0petfood_be\cart-service && npm run dev"
timeout /t 2 /nobreak >nul

echo [9/16] Starting Coupon Service (port 3008)...
start "Coupon Service :3008" cmd /k "cd /d %~dp0petfood_be\coupon-service && npm run dev"
timeout /t 2 /nobreak >nul

echo [10/16] Starting Payment Service (port 3009)...
start "Payment Service :3009" cmd /k "cd /d %~dp0petfood_be\payment-service && npm run dev"
timeout /t 2 /nobreak >nul

echo [11/16] Starting Notification Service (port 3010)...
start "Notification Service :3010" cmd /k "cd /d %~dp0petfood_be\notification-service && npm run dev"
timeout /t 2 /nobreak >nul

echo [12/16] Starting AI Service (port 3011)...
start "AI Service :3011" cmd /k "cd /d %~dp0petfood_be\ai-service && npm run dev"
timeout /t 2 /nobreak >nul

echo [13/16] Starting Chat Service (port 3012)...
start "Chat Service :3012" cmd /k "cd /d %~dp0petfood_be\chat-service && npm run dev"


echo [14/16] Starting Review Service (port 3013)...
start "Review Service :3013" cmd /k "cd /d %~dp0petfood_be\review-service && npm run dev"

echo [15/16] Starting Reward Service (port 3014)...
start "Reward Service :3014" cmd /k "cd /d %~dp0petfood_be\reward-service && npm run dev"

echo [16/16] Starting Appointment Service (port 3015)...
start "Appointment Service :3015" cmd /k "cd /d %~dp0petfood_be\appointment-service && npm run dev"
echo.
echo ========================================
